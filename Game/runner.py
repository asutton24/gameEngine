...
def main():
    ...
    block = GameObject(Sprite('block.txt', 400, 200, (255, 255, 255), -1,5, screen), True, 1, False)
    room1 = Room('Manifest\\RoomManifest.txt', 0, (0, 0, 0), screen)
    room1.setDoors(True, True, True, True)
    testEnemy = Enemy([Sprite('enemyR.txt', 100, 100, (255, 0, 0), 10, 6, screen), Sprite('enemyL.txt', 100, 100, (255, 0, 0), 10, 6, screen)], 2, 3, 3, 128, False, 100, [], 0, [], [])
    faceTest = Enemy([Sprite('d.txt', 300, 200, (0, 255, 0), -1, 8, screen), Sprite('l.txt', 100, 100, (0, 255, 0), -1, 8, screen), Sprite('u.txt', 100, 100, (0, 255, 0), -1, 8, screen), Sprite('r.txt', 100, 100, (0, 255, 0), -1, 8, screen)], 4, 4, 1, 1, False, 1, [], 0, [], [[300, 200], [400, 200], [400, 300], [300, 300], 1])
    count = 0
    while running:
